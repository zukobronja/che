...
public interface ProcessesPanelView extends View<ProcessesPanelView.ActionDelegate> {
  ...
  interface ActionDelegate extends BaseActionDelegate {
     ...
     * @param creationContext context creation terminal. @see {@link TerminalCreationContext}
     */
    void onAddTerminal(String machineId, TerminalCreationContext creationContext);
